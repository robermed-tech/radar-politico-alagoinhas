...
PERFIS = {
    ...
    "alagonoticias":        {"categoria": "Oposição",   "filtro": "oposicao"},
    "alagoinhasurgente":    {"categoria": "Oposição",   "filtro": "oposicao"},
    "vereador.alagoinhas":  {"categoria": "Oposição",   "filtro": "oposicao"},
    "politicaalagoinhas":   {"categoria": "Oposição",   "filtro": "oposicao"},
    "fiscaliza.alagoinhas": {"categoria": "Oposição",   "filtro": "oposicao"},
    "oposicaoalagoinhas":   {"categoria": "Oposição",   "filtro": "oposicao"},
    "municipioalagoinhas":  {"categoria": "Oposição",   "filtro": "oposicao"},
    # Imprensa
