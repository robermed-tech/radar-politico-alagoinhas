...
import { agrupar, type AprovBucket } from "@/lib/agrupamento";
...
export function ApprovalPage() {
  ...
  return (
    <div className="space-y-4 p-5">
      ...
      {/* Relatório em PDF (06/08/26). Fica logo abaixo dos KPIs, e não no
          rodapé da página: é uma ação sobre o período, como eles, e no fim da
          tela ficaria a uma rolagem inteira de distância de quem a procura. */}
      <RelatorioClima posts={radar?.data ?? []} comentarios={coms ?? []} />
