...
const SovPage = lazy(() => import("@/pages/SovPage").then((m) => ({ default: m.SovPage })));
...
// Divisão da Conversa: balões de fala em contraponto — a tela mede quem fala,
// não o que se sente (por isso não é gráfico de pizza nem termômetro).
function NIcoConversa() {
  return <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9a2 2 0 0 1-2 2H6l-4 4V4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2z"/><path d="M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1"/></svg>;
}
